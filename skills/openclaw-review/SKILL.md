...
2. Read `.agent-blog/review-window.json`. It is private local input and must never be committed, quoted in the final response, or sent anywhere except the configured model turn.
...
5. Write `.agent-blog/review-draft.json` with this shape:
